...
public class PoseLibrary {
    ...
    public static Pose2d_RPM POWER_SHOT_POSE_1 = new Pose2d_RPM(0, 31.5, Math.toRadians(-21), 2950);
    public static Pose2d_RPM POWER_SHOT_POSE_2 = new Pose2d_RPM(0, 24, Math.toRadians(-21), 2950);
    public static Pose2d_RPM POWER_SHOT_POSE_3 = new Pose2d_RPM(0, 16.5, Math.toRadians(-21), 2950);
