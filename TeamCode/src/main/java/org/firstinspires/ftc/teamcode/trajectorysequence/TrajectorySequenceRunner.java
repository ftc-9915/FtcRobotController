...
public class TrajectorySequenceRunner {
    ...
    private double turnTimeout = 0.5;
    ...
    public TrajectorySequenceRunner(TrajectoryFollower follower, PIDCoefficients headingPIDCoefficients, double turnTimeout) {
        this(follower, headingPIDCoefficients);
    ...
    DriveSignal update(Pose2d poseEstimate, Pose2d poseVelocity) {
        ...
        if (currentTrajectorySequence != null) {
            ...
            if (currentSegment instanceof TrajectorySegment) {
                ...
                if (deltaTime >= currentSegment.getDuration() + turnTimeout) {
                    currentSegmentIndex++;
                    driveSignal = new DriveSignal();
                }
