...
public class MecanumDrivebase extends com.acmerobotics.roadrunner.drive.MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(5.46, 0, 0.4);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(14, 0, 0.2);
    public static PIDCoefficients POINT_TURN_PID = new PIDCoefficients(15, 0, 0.1);
    ...
    private static double FOLLOWER_X_TOLERANCE = 0.5;
    private static double FOLLOWER_Y_TOLERANCE = 0.5;
    private static double FOLLOWER_HEADING_TOLERANCE = Math.toRadians(1.0);
    private static double FOLLOWER_TIMEOUT = 0.5;
    ...
    public MecanumDrivebase(HardwareMap hardwareMap) {
        ...
        follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
                new Pose2d(FOLLOWER_X_TOLERANCE, FOLLOWER_Y_TOLERANCE, FOLLOWER_HEADING_TOLERANCE), FOLLOWER_TIMEOUT);
    ...
    public void changeTimeout(double timeout, double turnTimeout){
        FOLLOWER_TIMEOUT = timeout;
        follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
                new Pose2d(FOLLOWER_X_TOLERANCE, FOLLOWER_Y_TOLERANCE, FOLLOWER_HEADING_TOLERANCE), FOLLOWER_TIMEOUT);
        trajectorySequenceRunner = new TrajectorySequenceRunner(follower, HEADING_PID, turnTimeout);
    }
